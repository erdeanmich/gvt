...
const app = ((() => {
  ...
  function initModels() {
    ...
    createModel(torus, 'fill', [1, 1, 1, 1], [0, 0.75, 0], [0, 0, 0], [1, 1, 1], redMaterial);
    createModel(sphere, 'fill', [1, 1, 1, 1], [-1.25, 0.5, 0], [0, 0, 0], [1, 1, 1], greenMaterial);
    createModel(sphere, 'fill', [1, 1, 1, 1], [1.25, 0.5, 0], [0, 0, 0], [1, 1, 1], blueMaterial);
  ...
  function moveLights() {
    ...
    illumination.light[1].position[0] = Math.cos(Math.PI + lightRotation) * radius;
    illumination.light[1].position[2] = Math.sin(Math.PI + lightRotation) * radius;
  }
